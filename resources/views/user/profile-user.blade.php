    ...
    <div class="container mx-auto p-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <!-- <div class="mt-6">
                ...
                @if ($connectGoogle)
                    <button onclick="confirmDelete()" class="border border-gray-300 text-gray-700 font-bold py-2 px-4 rounded-xl w-full flex items-center justify-center hover:bg-blue-400 hover:text-white gap-2">
                ...
                <div class="flex items-center justify-between flex-col sm:flex-row">
                    @if ($connectGoogle)
                        ...
                        <div class="w-full sm:w-auto mb-4 sm:mb-0">
                            ...
                            <p class="text-gray-600">Akun ini sudah terhubung dengan Google untuk akses lebih mudah.</p>
                        </div>
                        ...
                        <button onclick="confirmDelete()" class="border border-gray-300 text-gray-700 font-bold py-2 px-4 rounded-xl flex items-center justify-center hover:bg-blue-400 hover:text-white gap-2 w-full sm:w-auto">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="20px" height="20px" class="flex-shrink-0">
                                <path fill="#EA4335" d="M24 9.5c3.5 0 6.2 1.4 8.1 2.6l6-6C34.6 3.1 29.8 1 24 1 14.7 1 7 6.8 3.3 14.2l7.6 5.8C12.7 13.1 17.9 9.5 24 9.5z" />
                                <path fill="#34A853" d="M46.4 24.1c0-1.5-.2-3-.5-4.4H24v8.9h12.7c-.5 3-2 5.5-4.1 7.3l6.3 4.9c3.6-3.3 5.7-8.1 5.7-13.8z" />
                                <path fill="#4A90E2" d="M9.9 27c-1.3-.9-2.4-2-3.2-3.3L0 27.4C2.8 32.6 7.9 36.4 14 37.4v-7.5c-2.4-.5-4.6-1.6-6.5-3.2z" />
                    ...
                    @else
                        ...
                        <a href="{{route('oauth.google')}}">
                            ...
                            <button class="border border-gray-300 text-gray-700 font-bold py-2 px-4 rounded-xl flex items-center justify-center hover:bg-blue-400 hover:text-white gap-2 w-full sm:w-auto">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="20px" height="20px" class="flex-shrink-0">
                                    <path fill="#EA4335" d="M24 9.5c3.5 0 6.2 1.4 8.1 2.6l6-6C34.6 3.1 29.8 1 24 1 14.7 1 7 6.8 3.3 14.2l7.6 5.8C12.7 13.1 17.9 9.5 24 9.5z" />
                                    <path fill="#34A853" d="M46.4 24.1c0-1.5-.2-3-.5-4.4H24v8.9h12.7c-.5 3-2 5.5-4.1 7.3l6.3 4.9c3.6-3.3 5.7-8.1 5.7-13.8z" />
                                    <path fill="#4A90E2" d="M9.9 27c-1.3-.9-2.4-2-3.2-3.3L0 27.4C2.8 32.6 7.9 36.4 14 37.4v-7.5c-2.4-.5-4.6-1.6-6.5-3.2z" />
            ...
            <!-- <div class="mt-6">
                <div class="flex items-center justify-between flex-col sm:flex-row">
                    ...
                    @else
                        ...
                        <a href="{{ route('oauth.google') }}" class="w-full sm:w-auto">
                            <button class="border border-gray-300 text-gray-700 font-bold py-2 px-4 rounded-xl flex items-center justify-center hover:bg-blue-400 hover:text-white gap-2 w-full sm:w-auto">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="20px" height="20px" class="flex-shrink-0">
                                    <path fill="#EA4335" d="M24 9.5c3.5 0 6.2 1.4 8.1 2.6l6-6C34.6 3.1 29.8 1 24 1 14.7 1 7 6.8 3.3 14.2l7.6 5.8C12.7 13.1 17.9 9.5 24 9.5z" />
                                    <path fill="#34A853" d="M46.4 24.1c0-1.5-.2-3-.5-4.4H24v8.9h12.7c-.5 3-2 5.5-4.1 7.3l6.3 4.9c3.6-3.3 5.7-8.1 5.7-13.8z" />
    ...
    <script>
        function confirmDelete() {
            Swal.fire({
                ...
                text: "Koneksi akun Google Anda akan terputus",
                icon: 'warning',
